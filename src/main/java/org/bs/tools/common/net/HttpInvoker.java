package org.bs.tools.common.net;
...
import org.bs.tools.common.net.cache.SslContextCache;
...
public class HttpInvoker
{
    ...
    HttpInvoker(String interfaceName, boolean isHttps)
    {
        ...
        if (isHttps && !SslContextCache.containInterfaceName(interfaceName))
        {
            ...
            try
            {
                ...
                SslContextCache.putSslContext(interfaceName, sslContext);
            }
            catch (Exception e)
            {
                // err log
    ...
    HttpInvoker(String interfaceName, byte[] cerFile, boolean forceUpdate)
    {
        ...
        if (forceUpdate || !SslContextCache.containInterfaceName(interfaceName))
        {
    ...
    private CloseableHttpClient getHttpsClient()
    {
        ...
        SSLContext sslContext = SslContextCache.getSslContext(interfaceName);
        ...
        Registry<ConnectionSocketFactory> registry =
                RegistryBuilder.<ConnectionSocketFactory>create().register("https", PlainConnectionSocketFactory.INSTANCE)
                        .build();
